    ...
    <div class="app-footer">
      ...
      >
        <div class="d-flex align-items-center">
          ...
          <div>
            <div>
              <p class="m-0">&copy; 2021 {{$t('developed_by')}}
                <a href="https://ytechub.com" target="_blank"> <img src="/images/Y-Tech Logo Darker@3x.png" alt="Y-TECH" width="50" height="60"> </a>
                 {{currentUser.developed_by}}</p>
